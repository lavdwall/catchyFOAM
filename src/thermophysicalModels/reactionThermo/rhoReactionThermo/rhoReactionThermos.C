...
#define makeGSRhoReactionThermos(Mixture, SThermoPhysics, GThermoPhysics)      \
    makeGSReactionThermos                                                      \
    (                                                                          \
        rhoThermo,                                                             \
        rhoReactionThermo,                                                     \
        heRhoThermo,                                                           \
...
namespace Foam
{
    ...
    forGasSolids(makeGSRhoReactionThermos, multiComponentGSMixture);
}
