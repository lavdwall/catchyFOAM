...
(
    ...
    scalar (MixtureType::gthermoType::*psiMethod)
    (
        const scalar,
        const scalar
    ) const,
...
{
    const typename MixtureType::gthermoType& thermo =
...
{
    return fieldProperty(&MixtureType::gthermoType::HE, speciei, p, T);
}
...
{
    return fieldProperty(&MixtureType::gthermoType::Hs, speciei, p, T);
}
...
{
    return fieldProperty(&MixtureType::gthermoType::Ha, speciei, p, T);
}
...
) const
{
    ...
    (
        "alphah",
        dimMass/dimLength/dimTime,
        &MixtureType::gthermoType::alphah,
        speciei,
        p,
        T
    );
