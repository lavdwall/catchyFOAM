...
)
{
    ...
    else if (thermoDict.isDict("solidThermoType"))
    {
        const dictionary& sThermoTypeDict(thermoDict.subDict("solidThermoType"));
        const dictionary& gThermoTypeDict(thermoDict.subDict("gasThermoType"));

        Info<< "Selecting solid thermodynamics package " << sThermoTypeDict << endl;
        Info<< "Selecting gas thermodynamics package " << gThermoTypeDict << endl;
        ...
        const word thermoTypeName
        (
            word(sThermoTypeDict.lookup("type")) + '<'
          + word(sThermoTypeDict.lookup("mixture")) + '<'
          + word(sThermoTypeDict.lookup("transport")) + '<'
          + word(sThermoTypeDict.lookup("thermo")) + '<'
          + word(sThermoTypeDict.lookup("equationOfState")) + '<'
          + word(sThermoTypeDict.lookup("specie")) + ">>,"
          + word(sThermoTypeDict.lookup("energy")) + ">,"
          + word(gThermoTypeDict.lookup("transport")) + '<'
          + word(gThermoTypeDict.lookup("thermo")) + '<'
          + word(gThermoTypeDict.lookup("equationOfState")) + '<'
          + word(gThermoTypeDict.lookup("specie")) + ">>,"
          + word(gThermoTypeDict.lookup("energy"))+ ">>>"
        );
