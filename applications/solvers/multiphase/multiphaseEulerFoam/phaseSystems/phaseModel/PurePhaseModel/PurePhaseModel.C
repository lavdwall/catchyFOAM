...
{
    FatalErrorInFunction
        << "Cannot access the species fractions for a pure phase"
        << exit(FatalError);
...
template<class BasePhaseModel>
Foam::tmp<Foam::fvScalarMatrix>
Foam::PurePhaseModel<BasePhaseModel>::YsiEqn(volScalarField& Ysi)
{
    FatalErrorInFunction
        << "Cannot construct a solid species fraction equation for a pure phase"
        << exit(FatalError);
...
template<class BasePhaseModel>
const Foam::PtrList<Foam::volScalarField>&
Foam::PurePhaseModel<BasePhaseModel>::Ys() const
{
    return Y_;
}
...
template<class BasePhaseModel>
const Foam::volScalarField&
Foam::PurePhaseModel<BasePhaseModel>::Ys(const word& name) const
{
    FatalErrorInFunction
        << "Cannot get a solid species fraction by name from a pure phase"
        << exit(FatalError);
...
template<class BasePhaseModel>
Foam::PtrList<Foam::volScalarField>&
Foam::PurePhaseModel<BasePhaseModel>::YsRef()
{
    FatalErrorInFunction
        << "Cannot access the solid species fractions for a pure phase"
        << exit(FatalError);
...
template<class BasePhaseModel>
const Foam::UPtrList<Foam::volScalarField>&
Foam::PurePhaseModel<BasePhaseModel>::YsActive() const
{
    return Y_;
}
...
template<class BasePhaseModel>
Foam::UPtrList<Foam::volScalarField>&
Foam::PurePhaseModel<BasePhaseModel>::YsActiveRef()
{
    FatalErrorInFunction
        << "Cannot access the solid species fractions for a pure phase"
        << exit(FatalError);
