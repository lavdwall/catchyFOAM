...
template<class BasePhaseModel>
Foam::tmp<Foam::fvScalarMatrix>
Foam::MultiComponentPhaseModel<BasePhaseModel>::YsiEqn(volScalarField& Ysi)
{
    FatalErrorInFunction
        << "Cannot construct a solid species fraction equation for a gas only multicomponent phase"
        << exit(FatalError);
...
template<class BasePhaseModel>
const Foam::PtrList<Foam::volScalarField>&
Foam::MultiComponentPhaseModel<BasePhaseModel>::Ys() const
{
    return Ys_;
}
...
template<class BasePhaseModel>
const Foam::volScalarField&
Foam::MultiComponentPhaseModel<BasePhaseModel>::Ys(const word& name) const
{
    FatalErrorInFunction
        << "Cannot get a solid species fraction by name from a gas only multicomponent phase"
        << exit(FatalError);
...
template<class BasePhaseModel>
Foam::PtrList<Foam::volScalarField>&
Foam::MultiComponentPhaseModel<BasePhaseModel>::YsRef()
{
    FatalErrorInFunction
        << "Cannot access the solid species fractions for a gas only multicomponent phase"
        << exit(FatalError);
...
template<class BasePhaseModel>
const Foam::UPtrList<Foam::volScalarField>&
Foam::MultiComponentPhaseModel<BasePhaseModel>::YsActive() const
{
    return Ys_;
}
...
template<class BasePhaseModel>
Foam::UPtrList<Foam::volScalarField>&
Foam::MultiComponentPhaseModel<BasePhaseModel>::YsActiveRef()
{
    return Ys_;
}
